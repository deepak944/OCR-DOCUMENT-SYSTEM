...
CAD_EXPORT_FOLDER = str(BASE_DIR / "cad_exports")
...
OCR_CPU_THREADS = _env_int("OCR_CPU_THREADS", 4)
OCR_FALLBACK_DPI = _env_int("OCR_FALLBACK_DPI", 150)
...
DISABLE_OCR_FALLBACK = _env_bool("DISABLE_OCR_FALLBACK", False)
DISABLE_CAMELOT = _env_bool("DISABLE_CAMELOT", False)
